...
const ball1 = create('blue', 5, 5);
const ball2 = create('red', 10, 10);
const ball3 = create('green', 5, 10);
const ball4 = create('orange',10,5);

moveTo(ball1, 1, 1);
moveTo(ball2, 0, 350);
moveTo(ball3, 550, 350);
moveTo(ball4, 550, 0);
